...
public class BalloonHint extends PopupWindow {
    ...
    public BalloonHint(Context context, View parent, int measureSpecMode) {
        ...
        setBackgroundDrawable(context.getResources().getDrawable(R.drawable.rounded_rect));
    ...
    private class BalloonView extends View {
        ...
        protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
            ...
            int measuredWidth = this.getPaddingLeft() + this.getPaddingRight();
            int measuredHeight = this.getPaddingTop() + this.getPaddingBottom();
            if (null != mIcon) {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (null != mIcon) {
                ...
                float x = this.getPaddingLeft();
                x += (width - labelMeasuredWidth - this.getPaddingLeft() - this.getPaddingRight()) / 2.0f;
